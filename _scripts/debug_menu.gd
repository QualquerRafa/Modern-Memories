...
func _on_change_card_id_button_up():
	get_node("../player_hand/card_0").update_card_information("00815")
	get_node("../player_hand/card_1").update_card_information("00967")
	get_node("../player_hand/card_2").update_card_information("00965")
	get_node("../player_hand/card_3").update_card_information("00781")
	get_node("../player_hand/card_4").update_card_information("00704")
