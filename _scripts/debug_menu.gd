...
func _on_change_card_id_button_up():
	get_node("../player_hand/card_0").update_card_information("00111")
	get_node("../player_hand/card_1").update_card_information("00112")
	get_node("../player_hand/card_2").update_card_information("00113")
	get_node("../player_hand/card_3").update_card_information("00114")
