...
func _on_change_card_id_button_up():
	get_node("../player_hand/card_0").update_card_information("01117")
	get_node("../player_hand/card_1").update_card_information("00553")
	get_node("../player_hand/card_2").update_card_information("00469")
	get_node("../player_hand/card_3").update_card_information("00560")
	get_node("../player_hand/card_4").update_card_information("01075")
